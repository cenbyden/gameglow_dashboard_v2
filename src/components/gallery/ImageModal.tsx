  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-[90vw] max-h-[90vh] p-0 gap-0 bg-transparent border-none">
        ...
        <div className="flex flex-col md:flex-row h-[85vh] rounded-lg overflow-hidden">
          {/* Image Container */}
          <div className="flex-1 bg-black flex items-center justify-center relative">
            ...
            {/* Favorite button in fullscreen view */}
            <Button 
              variant="ghost" 
              size="icon" 
              className={`absolute top-4 right-4 rounded-full ${image.isFavorite ? 'bg-accent-purple text-white' : 'bg-black/50 hover:bg-black/70 text-white'}`}
          ...
          {/* Info Panel */}
          <div className="w-full md:w-80 bg-dark glass-dark p-6 flex flex-col max-h-[30vh] md:max-h-full md:h-full overflow-y-auto">
